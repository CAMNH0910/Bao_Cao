...
namespace T41.Areas.Admin.Controllers
{
    ...
    public class CTTCKTController : Controller
    {
        ...
        [HttpPost]
        public JsonResult ListCTTCReport( string buucuc, string startdate, string enddate)
        {           
            ...
            returnKPIKT = KPIKTRepository.CTTC(buucuc,common.DateToInt(startdate), common.DateToInt(enddate) );
        ...
        [HttpGet]
        public List<CTTCDetail> ReturnListExcel(string buucuc, string startdate, string enddate)
        {
