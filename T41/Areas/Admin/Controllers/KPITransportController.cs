...
namespace T41.Areas.Admin.Controllers
{
    ...
    public class KPITransportController : Controller
    {
        ...
        private void BindingFormatForExcel(ExcelWorksheet worksheet, List<KPITransportTotal> listItems)
        {
            ...
            worksheet.Cells[1, 2].Value = "HUB";
            worksheet.Cells[1, 3].Value = "Tên HUB";
            worksheet.Cells[1, 4].Value = "Mã tỉnh nhận";
            worksheet.Cells[1, 5].Value = "Tên tỉnh nhận";          
            worksheet.Cells[1, 6].Value = "Tổng số";
            worksheet.Cells[1, 7].Value = "Tỉ lệ đúng quy định";
            worksheet.Cells[1, 8].Value = "SL quá chỉ tiêu";
            worksheet.Cells[1, 9].Value = "TL quá chỉ tiêu";
            worksheet.Cells[1, 10].Value = "SL không KPI";
            worksheet.Cells[1, 11].Value = "TL không KPI";
