...
namespace T41.Areas.Admin.Controllers
{
    public class DetailBD13Controller : Controller
    {
        ...
        [HttpGet]
        public List<BD13_DI_Detail> ReturnListExcel(int mabc_kt, int mabc, string ngay, int cakt, int chthu, int tuiso)
        {

            DetailBD13Repository bd13Repository = new DetailBD13Repository();
            ReturnBD13 returnbd13 = new ReturnBD13();
            returnbd13 = bd13Repository.BD13_DI_DETAIL(1, 5000, mabc_kt, mabc, common.DateToInt(ngay), cakt, chthu, tuiso);
            return returnbd13.ListBD13Report;
        }
        ...
        //Phần sửa excel
        private void BindingFormatForExcel(ExcelWorksheet worksheet, List<BD13_DI_Detail> listItems)
        {
        ...
        public ActionResult Export( int mabc_kt, int mabc, string ngay, int cakt, int chthu, int tuiso)
        {
            ...
            Response.AddHeader("Content-Disposition", "attachment; filename=Chi tiết e1_bd13_di_DATACENTER_" + mabc_kt + "_ngày_" + ngay + ".xlsx");
