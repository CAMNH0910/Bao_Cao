...
namespace T41.Areas.Admin.Controllers
{
    ...
    public class ReportTHDONVIDICHVUController : Controller
    {
        ...
        private void BindingFormatForExcel(ExcelWorksheet worksheet, List<QualityReportDONVIDICHVUDetail> listItems)
        {
            ...
            worksheet.Cells[1, 5].Value = "Phân loại DV";
            worksheet.Cells[1, 6].Value = "Mã Dịch vụ";
            worksheet.Cells[1, 7].Value = "Tên Dịch vụ";
            worksheet.Cells[1, 8].Value = "SL";
            worksheet.Cells[1, 9].Value = "KL";
            worksheet.Cells[1, 10].Value = "Cước chính";
            worksheet.Cells[1, 11].Value = "PPXD";
            worksheet.Cells[1, 12].Value = "PPVX";
            worksheet.Cells[1, 13].Value = "PPMD";
            worksheet.Cells[1, 14].Value = "Cước DVCT";
            worksheet.Cells[1, 15].Value = "Tổng cước";
