    ...
    public class DM_Lai_XeRepository
    {
        ...
        public ReturnDM_Lai_Xe DM_Lai_Xe_DETAIL(int zone,int endpostcode, string trangthai)
        {
            ...
            try
            {
                ...
                {
                    OracleCommand myCommand = new OracleCommand("DM_Lai_Xe.List_DM_Lai_Xe", Helper.OraDCDevOracleConnection);
        ...
        public ReturnResponseUpdate Khoa(int id)
        {
            ...
            try
            {
                ...
                OracleCommand myCommand = new OracleCommand("DM_LAI_XE.Khoa_Lai_Xe", Helper.OraDCDevOracleConnection);
                myCommand.CommandType = CommandType.StoredProcedure;
                myCommand.CommandTimeout = 20000;
        ...
        public ReturnDM_Lai_Xe CapNhat_Id_Sua(int id)
        {
            ...
            try
            {
                ...
                using (OracleCommand cmd = new OracleCommand())
                {
                    OracleCommand myCommand = new OracleCommand("DM_Lai_Xe.Lay_Lai_Xe", Helper.OraDCDevOracleConnection);
                    //xử lý tham số truyền vào data table   
                    myCommand.CommandType = CommandType.StoredProcedure;
                    myCommand.CommandTimeout = 20000;
                    OracleDataAdapter mAdapter = new OracleDataAdapter();
        ...
        public bool Add(DM_Lai_Xe_Sua model)
        {
            try
            {
                using (OracleCommand cmd = new OracleCommand("DM_Lai_Xe.Insert_DM_LAI_XE", Helper.OraDCDevOracleConnection))
                {
        ...
        public bool Edit(DM_Lai_Xe_Sua model)
        {
            try
            {
                using (OracleCommand cmd = new OracleCommand("DM_Lai_Xe.Update_DM_Lai_Xe_NEW", Helper.OraDCDevOracleConnection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
